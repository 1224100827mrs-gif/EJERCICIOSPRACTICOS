...
public class Caja {
 /** Identificador de la caja */
     ...
     */
    public void agregarCliente(Cliente c) { colaClientes.add(c); }
 ...
 * Los clientes se asignan a la caja con menos clientes
 * y luego son atendidos en orden
 * @author Marisol Rincón Solís
 */
public class  Supermercado {
  /** Arreglo de clientes con carritos */
